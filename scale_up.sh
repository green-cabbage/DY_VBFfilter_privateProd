...
singularity run --no-home /cvmfs/unpacked.cern.ch/registry.hub.docker.com/cmssw/$CONTAINER_NAME $(echo $(pwd)/EndOfLHE2Mini.sh)
...
ls -ltrh
echo "cp -f SMP-RunIISummer20UL18NanoAODv12-00008.root $3/nanoAODv12_$1_$2.root"
cp -f SMP-RunIISummer20UL18NanoAODv12-00008.root $3/nanoAODv12_$1_$2.root
...
export SINGULARITY_CACHEDIR="/tmp/$(whoami)/singularity"
singularity run --no-home /cvmfs/unpacked.cern.ch/registry.hub.docker.com/cmssw/$CONTAINER_NAME $(echo $(pwd)/EndOfMini2Nano.sh $1 $2 $3)