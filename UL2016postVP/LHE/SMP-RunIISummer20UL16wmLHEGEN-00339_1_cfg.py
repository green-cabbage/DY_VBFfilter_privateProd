...
process.configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('Configuration/GenProduction/python/SMP-RunIISummer20UL16wmLHEGEN-00339-fragment_4VBFFilter.py nevts:3668'),
...
process.RAWSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:SMP-RunIISummer20UL16wmLHEGEN-00339.root'),
...
process.LHEoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:SMP-RunIISummer20UL16wmLHEGEN-00339_inLHE.root'),
...
process.vbfGenJetFilterD = cms.EDFilter("VBFGenJetFilter",
    ...
    minLeadingJetsInvMass = cms.untracked.double(350.0),
