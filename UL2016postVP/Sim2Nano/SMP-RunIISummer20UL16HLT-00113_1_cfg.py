...
process.maxEvents = cms.untracked.PSet(
    input = cms.untracked.int32(1648),
    output = cms.untracked.int32(1648)
)

# Input source
process.source = cms.Source("PoolSource",
    dropDescendantsOfDroppedBranches = cms.untracked.bool(False),
    fileNames = cms.untracked.vstring('file:SMP-RunIISummer20UL16DIGIPremix-00110.root'),
...
process.configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('--eventcontent nevts:1648'),
...
process.RAWSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:SMP-RunIISummer20UL16HLT-00113.root'),
