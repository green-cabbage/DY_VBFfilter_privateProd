...
cd /afs/cern.ch/cms/PPD/PdmV/work/McM/submit/SMP-RunIISummer20UL16RECO-00113/
...
# Dump actual test code to a SMP-RunIISummer20UL16RECO-00113_test.sh file that can be run in Singularity
cat <<'EndOfTestFile' > SMP-RunIISummer20UL16RECO-00113_test.sh
#!/bin/bash
...
# Target input events changed to: `minimum_runtime / time_per_event * number_of_threads`: `600 / 2.78 * 1` = 216
# Target output events changed to: `target_input_events * event_efficiency`: `216 * 1` = 216
# Final target input events: 215
# Final target output events: 215
# This validation will be computed based on the target output events!
EVENTS=215


# cmsDriver command
cmsDriver.py  --eventcontent AODSIM --customise Configuration/DataProcessing/Utils.addMonitoring --datatier AODSIM --conditions 106X_mcRun2_asymptotic_v13 --step RAW2DIGI,L1Reco,RECO,RECOSIM --geometry DB:Extended --era Run2_2016 --python_filename SMP-RunIISummer20UL16RECO-00113_1_cfg.py --fileout file:SMP-RunIISummer20UL16RECO-00113.root --filein file:SMP-RunIISummer20UL16HLT-00113.root --number 215 --number_out 215 --runUnscheduled --no_exec --mc || exit $? ;

# End of SMP-RunIISummer20UL16RECO-00113_test.sh file
EndOfTestFile

# Make file executable
chmod +x SMP-RunIISummer20UL16RECO-00113_test.sh
...
singularity run --no-home /cvmfs/unpacked.cern.ch/registry.hub.docker.com/cmssw/$CONTAINER_NAME $(echo $(pwd)/SMP-RunIISummer20UL16RECO-00113_test.sh)
