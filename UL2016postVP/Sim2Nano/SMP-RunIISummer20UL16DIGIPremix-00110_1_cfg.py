...
process.maxEvents = cms.untracked.PSet(
    input = cms.untracked.int32(604),
    output = cms.untracked.int32(604)
)

# Input source
process.source = cms.Source("PoolSource",
    dropDescendantsOfDroppedBranches = cms.untracked.bool(False),
    fileNames = cms.untracked.vstring('file:SMP-RunIISummer20UL16SIM-00113.root'),
...
process.configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('--eventcontent nevts:604'),
...
process.PREMIXRAWoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:SMP-RunIISummer20UL16DIGIPremix-00110.root'),
