...
if __name__ == "__main__":
    ...
    nano_load_path = f"/eos/purdue/store/user/hyeonseo/Run2UL/UL2018/DYJetsToLL_M-105To160_VBFFilter_TuneCP5_PSweights_13TeV-amcatnloFXFX-pythia8/nanoV12_{save_path_name}"
    nanoOut_numbers = getFileNumbers(nano_load_path)
    # print(f"nanoOut_numbers: {nanoOut_numbers}")

    # get missing numbers
    missing_numbers = list(set(miniOut_numbers) - set(nanoOut_numbers))
