...
# with command line options: Configuration/GenProduction/python/HIG-RunIIFall18wmLHEGS-00419-fragment.py --eventcontent RAWSIM,LHE --customise Configuration/DataProcessing/Utils.addMonitoring --datatier GEN-SIM,LHE --conditions 102X_upgrade2018_realistic_v11 --beamspot Realistic25ns13TeVEarly2018Collision --customise_commands process.RandomNumberGeneratorService.externalLHEProducer.initialSeed=int(15) --step LHE,GEN,SIM --geometry DB:Extended --era Run2_2018 --python_filename HIG-RunIIFall18wmLHEGS-00419_1_cfg.py --fileout file:HIG-RunIIFall18wmLHEGS-00419.root --number 7674 --number_out 18 --no_exec --mc
...
process.maxEvents = cms.untracked.PSet(
    input = cms.untracked.int32(7674),
    output = cms.untracked.int32(18)
)
...
process.configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('Configuration/GenProduction/python/HIG-RunIIFall18wmLHEGS-00419-fragment.py nevts:7674'),
...
process.RAWSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:HIG-RunIIFall18wmLHEGS-00419.root'),
...
process.LHEoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:HIG-RunIIFall18wmLHEGS-00419_inLHE.root'),
...
process.externalLHEProducer = cms.EDProducer("ExternalLHEProducer",
    ...
    nEvents = cms.untracked.uint32(7674),
