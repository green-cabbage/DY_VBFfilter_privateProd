...
cd /afs/cern.ch/cms/PPD/PdmV/work/McM/submit/SMP-RunIISummer20UL16HLTAPV-00114/
...
# Dump actual test code to a SMP-RunIISummer20UL16HLTAPV-00114_test.sh file that can be run in Singularity
cat <<'EndOfTestFile' > SMP-RunIISummer20UL16HLTAPV-00114_test.sh
#!/bin/bash
...
# Target input events changed to: `minimum_runtime / time_per_event * number_of_threads`: `600 / 2.36 * 1` = 254
# Target output events changed to: `target_input_events * event_efficiency`: `254 * 1` = 254
# Final target input events: 253
# Final target output events: 253
# This validation will be computed based on the target output events!
EVENTS=253


# cmsDriver command
cmsDriver.py  --eventcontent RAWSIM --outputCommand "keep *_mix_*_*,keep *_genPUProtons_*_*" --customise Configuration/DataProcessing/Utils.addMonitoring --datatier GEN-SIM-RAW --inputCommands "keep *","drop *_*_BMTF_*","drop *PixelFEDChannel*_*_*_*" --conditions 80X_mcRun2_asymptotic_2016_TrancheIV_v6 --customise_commands 'process.source.bypassVersionCheck = cms.untracked.bool(True)' --step HLT:25ns15e33_v4 --geometry DB:Extended --era Run2_2016 --python_filename SMP-RunIISummer20UL16HLTAPV-00114_1_cfg.py --fileout file:SMP-RunIISummer20UL16HLTAPV-00114.root --filein file:SMP-RunIISummer20UL16DIGIPremixAPV-00107.root --number 253 --number_out 253 --no_exec --mc || exit $? ;

# End of SMP-RunIISummer20UL16HLTAPV-00114_test.sh file
EndOfTestFile

# Make file executable
chmod +x SMP-RunIISummer20UL16HLTAPV-00114_test.sh
...
singularity run --no-home /cvmfs/unpacked.cern.ch/registry.hub.docker.com/cmssw/$CONTAINER_NAME $(echo $(pwd)/SMP-RunIISummer20UL16HLTAPV-00114_test.sh)
