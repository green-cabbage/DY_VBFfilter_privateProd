...
cd /afs/cern.ch/cms/PPD/PdmV/work/McM/submit/SMP-RunIISummer20UL16SIMAPV-00114/
...
# Dump actual test code to a SMP-RunIISummer20UL16SIMAPV-00114_test.sh file that can be run in Singularity
cat <<'EndOfTestFile' > SMP-RunIISummer20UL16SIMAPV-00114_test.sh
#!/bin/bash
...
# cmsDriver command
cmsDriver.py  --eventcontent RAWSIM --customise Configuration/DataProcessing/Utils.addMonitoring --datatier GEN-SIM --conditions 106X_mcRun2_asymptotic_preVFP_v8 --beamspot Realistic25ns13TeV2016Collision --step SIM --geometry DB:Extended --era Run2_2016_HIPM --python_filename SMP-RunIISummer20UL16SIMAPV-00114_1_cfg.py --fileout file:SMP-RunIISummer20UL16SIMAPV-00114.root --filein file:SMP-RunIISummer20UL16wmLHEGENAPV-00317.root --number 100 --number_out 100 --runUnscheduled --no_exec --mc || exit $? ;

# End of SMP-RunIISummer20UL16SIMAPV-00114_test.sh file
EndOfTestFile

# Make file executable
chmod +x SMP-RunIISummer20UL16SIMAPV-00114_test.sh
...
singularity run --no-home /cvmfs/unpacked.cern.ch/registry.hub.docker.com/cmssw/$CONTAINER_NAME $(echo $(pwd)/SMP-RunIISummer20UL16SIMAPV-00114_test.sh)
