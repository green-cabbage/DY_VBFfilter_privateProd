...
cd /afs/cern.ch/cms/PPD/PdmV/work/McM/submit/SMP-RunIISummer20UL16DIGIPremixAPV-00107/
...
# Dump actual test code to a SMP-RunIISummer20UL16DIGIPremixAPV-00107_test.sh file that can be run in Singularity
cat <<'EndOfTestFile' > SMP-RunIISummer20UL16DIGIPremixAPV-00107_test.sh
#!/bin/bash
...
# Target input events changed to: `minimum_runtime / time_per_event * number_of_threads`: `600 / 3.08 * 1` = 195
# Target output events changed to: `target_input_events * event_efficiency`: `195 * 1` = 195
# Final target input events: 194
# Final target output events: 194
...
# End of SMP-RunIISummer20UL16DIGIPremixAPV-00107_test.sh file
EndOfTestFile

# Make file executable
chmod +x SMP-RunIISummer20UL16DIGIPremixAPV-00107_test.sh
...
singularity run --no-home /cvmfs/unpacked.cern.ch/registry.hub.docker.com/cmssw/$CONTAINER_NAME $(echo $(pwd)/SMP-RunIISummer20UL16DIGIPremixAPV-00107_test.sh)
