...
process.configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('Configuration/GenProduction/python/SMP-RunIISummer20UL16wmLHEGENAPV-00317-fragment_4VBFFilter.py nevts:'+str(Nevents)),
...
process.RAWSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:SMP-RunIISummer20UL16wmLHEGENAPV-00317.root'),
...
process.LHEoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:SMP-RunIISummer20UL16wmLHEGENAPV-00317_inLHE.root'),
